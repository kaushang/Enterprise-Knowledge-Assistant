        ...
        <div className="mb-8">
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
            <div className="flex flex-col gap-3">
              <label className="text-xs text-gray-500">Supported formats: PDF, TXT</label>
              <input
                id="file-input"
                type="file"
                accept=".pdf,.txt"
              ...
              <div>
                ...
                <select
                  ...
                  className="border border-gray-300 rounded px-3 py-2 text-sm text-black focus:outline-none focus:border-blue-600 bg-white"
                >
                  {CATEGORIES.map((cat) => (
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left text-xs font-semibold text-gray-600 py-2 pr-4">Category</th>
              ...
              <tbody>
                {documents.map((doc, i) => (
                  <tr key={i} className={`border-b border-gray-100 ${i % 2 === 0 ? "bg-white" : "bg-gray-50"}`}>
                    ...
                    <td className="py-2 pr-4 text-xs text-gray-600">{doc.category}</td>
